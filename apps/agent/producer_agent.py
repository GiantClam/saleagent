...
logger = logging.getLogger("producer_agent")
...
def build_producer_agent() -> Agent:
    """
    创建制片人 Agent，负责通过对话收集信息
    ...
    producer = Agent(
        ...
        backstory=(
            "你是一位经验丰富的视频制片人，拥有10年以上的视频制作经验。"
            "你擅长与客户沟通，能够通过系统性的提问高效收集视频制作所需的信息。"
            "你能够根据用户的回答，智能地判断还需要收集哪些信息，并生成合适的问题。"
            "你总是友好、专业，能够提供清晰的选项帮助用户快速做出选择。"
            "你的目标是高效、友好地收集完整信息，确保视频制作能够顺利进行。"
        ),
